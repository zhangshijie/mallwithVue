            ...
            <ul class="cart-item-list">
              <li v-for="product in cartList">
                  ...
                  <div class="item-quantity">
                    <div class="select-self">
                      <div class="select-self-area">
                        <span class="select-ipt">× {{ product.productNum }}</span>
                      </div>
                    </div>
                ...
                <div class="cart-tab-4">
                  <div class="item-price-total">{{ (product.salePrice * product.productNum) | currency('$') }} </div>
                </div>
              </li>
            </ul>
          </div>
...
export default {
    ...
    methods:{
      ...
      fetchOrder(){
        axios.get("/users/cartList", this.headerConfig).then((response)=>{
